...
cl_clustering123 <- read.csv("labels/label_123.csv")[,1]


p_value <- main_multi_test_fun(cl_clustering123, inter_l)
print(p_value)

result <- main_ART_cp_fun(cl_clustering123,"All")
print(result)
#coverage
...
#write.csv(result_list, file = paste0("ART 123 ", ".csv"))
